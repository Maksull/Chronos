        ...
        try {
            const response = await fetch(
                `http://localhost:3001/calendars/${calendarId}/invite-links`,
                {
                    ...
                    body: JSON.stringify({ expireInDays }),
                },
            );
                ...
                <div className="flex-1">
                    ...
                    <select
                     ...
                     bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                        <option value="">
                            {dict.calendar?.neverExpires || 'Never expires'}
                        </option>
                        <option value="1">
                            {dict.calendar?.expireIn1Day || 'Expires in 1 day'}
                        </option>
                        <option value="7">
                ...
                <button
                   ...
                   focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-70 disabled:cursor-not-allowed">
                    {creating ? (
                        ...
                        dict.calendar?.createInviteLink || 'Create Invite Link'
                    )}
                </button>
            </div>
