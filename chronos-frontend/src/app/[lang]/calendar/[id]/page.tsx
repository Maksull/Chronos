                            ...
                            <div className="flex flex-col sm:flex-row justify-between items-center mt-4 sm:mt-6 gap-3 sm:gap-4">
                                ...
                                <div className="flex items-center w-full sm:w-auto justify-between sm:justify-start">
                                    <div className="bg-gray-100 dark:bg-gray-700 p-1 rounded-lg flex items-center">
                                        ...
                                        <button
                                            onClick={handleToday}
                                            className="px-3 py-1 text-sm bg-indigo-600 dark:bg-gray-600 text-white dark:text-gray-300 hover:bg-indigo-700 dark:hover:bg-gray-500 border border-gray-300 dark:border-gray-600 rounded-md hover:bg-gray-50 dark:hover:bg-gray-500 transition-colors shadow-sm mx-1">
